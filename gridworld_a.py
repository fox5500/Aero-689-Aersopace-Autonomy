...
with open("A_Random100x100_Run_Data_100runs.csv", 'w', newline='') as file:
...
#
    ...
    #plot_grid(grid_dict,random_grid)
    ...
    # Perform A* search
    solution, explored_nodes, search_cost = list(a_star_search(random_grid))
    ...
    #plot_path(grid_dict, random_grid, move_sequence_astar)
    with open("A_Random100x100_Run_Data_100runs.csv", 'a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([iteration + 1, runtime, total_cost, explored_nodes, move_sequence_astar])    
print("DONE")