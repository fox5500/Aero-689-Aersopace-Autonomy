...
with open("IDS_Random100x100_Run_Data_100runs.csv", 'w', newline='') as file:
...
#
   #print(random_grid)
    ...
    start_x, start_y = np.argwhere(random_grid == 5)[0]
    goal_x, goal_y = np.argwhere(random_grid == 1)[0]
    ...
    for iteration in range(iterations):
        ...
        while True:
            ...
            solution, explored_nodes, search_cost = ids_search(random_grid, (start_x, start_y), (goal_x, goal_y), depth_limit)
    ...
    solution, explored_nodes, total_cost = ids_search(random_grid, (start_x, start_y), (goal_x, goal_y), depth_limit)
    ...
    with open("IDS_Random100x100_Run_Data_100runs.csv", 'a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([iteration + 1, runtime, total_cost, explored_nodes, move_sequence_ids])    
print("DONE")
